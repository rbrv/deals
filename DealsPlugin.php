...
class DealsPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Allow deals in Craft Commerce');
    }
    ...
    public function commerce_registerOrderAdjusters(){
	  require_once('Adjusters/Deals.php');
	  return [
	    new \Commerce\Adjusters\Deals
	  ];
	}
}